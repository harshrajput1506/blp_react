...
export const whyUsContent1 = `Unlike other political parties, Bharatiya Liberal Party (BLP) has made corruption its main issue. BLP is committed to eliminating corruption from the government. To achieve this, the very first step Bharatiya Liberal Party (BLP) will take is to formulate an Anti-Corruption Commission (ACC) that will monitor the functioning of different departments of the government. ACC is vital to bring transparency in different government institutions in the Delhi state. `;
...
export const socials = [
  {
    label: "Instagram",
    link: "https://www.instagram.com/blpnow/",
    icon: Instagram,
  },
  ...
  {
    label: "Twitter",
    link: "https://twitter.com/joinblp",
    icon: Twitter,
  },

  {
    label: "Facebook",
    link: "https://www.facebook.com/JoinBLP/",
    icon: Facebook,
  },

  {
    label: "LinkedIn",
    link: "https://www.linkedin.com/company/joinblp/",
    icon: Linkedin,
  },
];
